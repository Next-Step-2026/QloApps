                ...
                {foreach from=$arrivals item=arrival}
                    <tr>
                        ...
                        <td class="text-center">
                            ...
                            {else}
                                <span class="text-muted" data-toggle="tooltip" data-placement="top" title="{l s='Horário padrão do hotel (não informado pelo hóspede)' mod='qloarrivalsharing'}" style="cursor: help;">
                                    <i class="icon-time"></i> 14:00
                                </span>
                            {/if}
                        </td>
                        <td class="text-center">
